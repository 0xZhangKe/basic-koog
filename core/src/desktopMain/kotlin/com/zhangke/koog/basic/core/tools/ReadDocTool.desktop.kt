...
actual fun readBundledDoc(fileName: String): ReadDocTool.ReadDocResult {
    ...
    val classLoader = Thread.currentThread().contextClassLoader ?: ReadDocTool::class.java.classLoader
    ...
    return ReadDocTool.ReadDocResult(
        fileName = fileName,
        content = content,
    )
}
